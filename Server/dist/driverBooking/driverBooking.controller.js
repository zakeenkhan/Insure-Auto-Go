...
let DriverBookingController = class DriverBookingController {
    ...
    async create(req, createBookingDto) {
        ...
        const [driverAvailability] = await Promise.all([
        ...
        if (!driverAvailability.available) {
            throw new common_1.BadRequestException('Driver is not available', {
                cause: driverAvailability.bookings,
            });
        }
...
], DriverBookingController.prototype, "create", null);
__decorate([
    (0, common_1.Get)(),
    (0, common_1.UseGuards)(guards_1.JwtAuthGuard, guards_1.isVerifiedUserGuard, (0, role_guard_1.RoleGuard)(['admin', 'appUser'])),
...
], DriverBookingController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.UseGuards)(guards_1.JwtAuthGuard, guards_1.isVerifiedUserGuard, (0, role_guard_1.RoleGuard)(['admin', 'appUser'])),
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], DriverBookingController.prototype, "cancelBooking", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], DriverBookingController.prototype, "changeBookingStatus", null);
exports.DriverBookingController = DriverBookingController = __decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiTags)('Driver Booking'),
    (0, common_1.Controller)('driver-booking'),
    __metadata("design:paramtypes", [driverBooking_service_1.DriverBookingService])
], DriverBookingController);
//# sourceMappingURL=driverBooking.controller.js.map